...
export function ComprovanteClient({
  ...
  return (
    <div className="p-6">
      ...
      {mostrarCliente && (
        <pre
          className={`mx-auto w-[30ch] whitespace-pre-wrap break-words font-mono text-[11px] font-bold leading-snug text-black ${
      ...
      {mostrarCozinha && (
        <pre className="mx-auto w-[30ch] whitespace-pre-wrap break-words font-mono text-[11px] font-bold leading-snug text-black">
